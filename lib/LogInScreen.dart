                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color: Color(0xff2E001F),width: 1)
                    ),
            ...
            Padding(padding: EdgeInsets.only(right: 20),
                child: Container(
                  ...
                  child: InkWell(
                    ...
                    child: Text("Forgot password ?",style: TextStyle(color: Color(0xff2E001F)),
                  ...
                  children: <Widget>[
                    ...
                    FlatButton(onPressed: (){
                      Navigator.of(context).pushReplacement(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text("Sign Up",style: TextStyle(color: Color(0xff2E001F)),),
